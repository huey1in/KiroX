  ...
  var DICT = {
    zh: {
      ...
      register: {
        ...
        cloudmailHint: '使用 Cloud-Mail 自部署邮箱注册。每次注册会创建永久账号，需手动清理。',
    ...
    en: {
      ...
      register: {
        ...
        cloudmailHint: 'Register using self-hosted Cloud-Mail. Each run creates a permanent account — clean up manually.',
    ...
    ja: {
      ...
      register: {
        ...
        cloudmailHint: '自己ホスト型 Cloud-Mail で登録します。毎回永続的なアカウントが作成されるため、手動で削除してください。',
