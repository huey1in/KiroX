  ...
  var DICT = {
    zh: {
      ...
      settings: {
        ...
        wafSolver: 'AWS WAF 打码', wafSolverDesc: '通过 2Captcha 处理 AWS WAF；静态参数留空时自动处理登录过程中返回的动态挑战', twoCaptchaAPIKey: '2Captcha API Key', wafWebsiteURL: 'WAF Website URL', wafWebsiteKey: 'WAF Website Key', wafJSAPIScript: 'jsapiScript',
    ...
    en: {
      ...
      settings: {
        ...
        wafSolver: 'AWS WAF solver', wafSolverDesc: 'Solve AWS WAF through 2Captcha; leave static parameters empty to handle login challenges automatically', twoCaptchaAPIKey: '2Captcha API Key', wafWebsiteURL: 'WAF Website URL', wafWebsiteKey: 'WAF Website Key', wafJSAPIScript: 'jsapiScript',
    ...
    ja: {
      ...
      settings: {
        ...
        wafSolver: 'AWS WAF CAPTCHA', wafSolverDesc: '2Captcha で AWS WAF を処理します。静的パラメータが空の場合はログイン中の動的チャレンジを自動処理します', twoCaptchaAPIKey: '2Captcha API Key', wafWebsiteURL: 'WAF Website URL', wafWebsiteKey: 'WAF Website Key', wafJSAPIScript: 'jsapiScript',
